...
namespace s21 {
    ...
    void TetrisView::keyPressEvent(QKeyEvent *e) {
        switch (e->key()) {
            case Qt::Key_P: m_gameModel->setGameControl(TetrisGameModel::PAUSE_GAME);break;
            case Qt::Key_Return: m_gameModel->setGameControl(TetrisGameModel::STAR_GAME); break;
            case Qt::Key_A: m_gameModel->setGameControl(TetrisGameModel::MOVE_LEFT); break;
            case Qt::Key_D: m_gameModel->setGameControl(TetrisGameModel::MOVE_RIGHT); break;
            case Qt::Key_R: m_gameModel->setGameControl(TetrisGameModel::MOVE_UP); break;
            case Qt::Key_S: m_gameModel->setGameControl(TetrisGameModel::MOVE_DOWN); break;
            case Qt::Key_G: m_gameModel->setGameControl(TetrisGameModel::STOP_GAME); break;
            case Qt::Key_Escape: m_gameModel->setGameControl(TetrisGameModel::EXIT_GAME); break;
        }
    }
