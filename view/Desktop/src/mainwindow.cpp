...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
  ...
  connect(m_startScreen->getTetrisBtn(), &QPushButton::clicked, this,
          &MainWindow::openTetris);
  connect(m_startScreen->getSnakeBtn(), &QPushButton::clicked, this,
          &MainWindow::openSnake);
}
